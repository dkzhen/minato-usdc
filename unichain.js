...
const contractAddress = "0xd8995f43f2152Ea7F73f3630a98710F1fD520859";
...
async function executeContract() {
  try {
    ...
    const _amount = ethers.utils.parseEther("0.000001");
    const tx = await contract.claimRewards({
      gasLimit: gasLimit,
      gasPrice: increasedGasPrice, // Since the function is payable
    });
