...
// Assuming you have a provider and signer already set up
const provider = new ethers.getDefaultProvider(process.env.PROVIDER_URL);
const wallet = new ethers.Wallet(process.env.PRIVATE_KEY, provider);

const contractAddress = "0xBA483Aa89BD0D75C509789CE27bAe6dE9988c862";
const contractABI = [
  {
    inputs: [
      {
...
const _amount = ethers.utils.parseEther("0.00001");
const amountStake = ethers.utils.parseEther("1"); // Example: staking 1 ether

async function stakeTokens() {
  try {
    const transaction = await contract.stake(amountStake, {
      value: _amount, // Since the function is payable
    });
